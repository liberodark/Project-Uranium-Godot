extends Node2D # gen_map.py Map013

var map_name = "Rochfale Town(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(432, 528):
		Global.game.play_dialogue("MAP013_NPC_1")
	if check_pos == Vector2(560, 336):
		Global.game.play_dialogue("MAP013_NPC_2")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/RochfaleTown/Rochfale_Town.tscn"
