extends Node2D # gen_map.py Map127

var map_name = "Victory Road"
...
func interaction(check_pos : Vector2, _direction):
	if get_node_or_null("NPC_Layer/Item1") != null and check_pos == $NPC_Layer/Item1.position:
		...
		Global.past_events.append("MAP127_ITEM_1_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item2") != null and check_pos == $NPC_Layer/Item2.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_2_TAKEN")
		Global.inventory.add_item_by_id_multiple(95, 1)
		Global.game.recive_item(95)
		$NPC_Layer/Item2.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item3") != null and check_pos == $NPC_Layer/Item3.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_3_TAKEN")
		Global.inventory.add_item_by_id_multiple(269, 1)
		Global.game.recive_item(269)
		$NPC_Layer/Item3.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item4") != null and check_pos == $NPC_Layer/Item4.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_4_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item5") != null and check_pos == $NPC_Layer/Item5.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_5_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item6") != null and check_pos == $NPC_Layer/Item6.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_6_TAKEN")
		Global.inventory.add_item_by_id_multiple(313, 1)
		Global.game.recive_item(313)
		$NPC_Layer/Item6.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item7") != null and check_pos == $NPC_Layer/Item7.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_7_TAKEN")
		Global.inventory.add_item_by_id_multiple(97, 1)
		Global.game.recive_item(97)
		$NPC_Layer/Item7.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item8") != null and check_pos == $NPC_Layer/Item8.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_8_TAKEN")
		Global.inventory.add_item_by_id_multiple(96, 1)
		Global.game.recive_item(96)
		$NPC_Layer/Item8.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item9") != null and check_pos == $NPC_Layer/Item9.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_9_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item10") != null and check_pos == $NPC_Layer/Item10.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_10_TAKEN")
		Global.inventory.add_item_by_id_multiple(196, 1)
		Global.game.recive_item(196)
		$NPC_Layer/Item10.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item11") != null and check_pos == $NPC_Layer/Item11.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_11_TAKEN")
		Global.inventory.add_item_by_id_multiple(524, 1)
		Global.game.recive_item(524)
		$NPC_Layer/Item11.queue_free()
		await Global.game.end_of_event
		Global.game.release_player()
	if get_node_or_null("NPC_Layer/Item12") != null and check_pos == $NPC_Layer/Item12.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_12_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item13") != null and check_pos == $NPC_Layer/Item13.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_13_TAKEN")
	...
	if get_node_or_null("NPC_Layer/Item14") != null and check_pos == $NPC_Layer/Item14.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_14_TAKEN")
		Global.inventory.add_item_by_id_multiple(181, 1)
		Global.game.recive_item(181)
	...
	if get_node_or_null("NPC_Layer/Item15") != null and check_pos == $NPC_Layer/Item15.position:
		Global.game.lock_player()
		Global.past_events.append("MAP127_ITEM_15_TAKEN")
		Global.inventory.add_item_by_id_multiple(590, 1)
		Global.game.recive_item(590)
...
var _trainer_data = {
	"Trainer1": {"pre": "MAP127_TRAINER_1", "defeat": "MAP127_TRAINER_1_DEFEAT", "portrait": "Graphics/Characters/trainer081.png"},
	"Trainer2": {"pre": "MAP127_TRAINER_2", "defeat": "MAP127_TRAINER_2_DEFEAT", "portrait": "Graphics/Characters/trainer061.png"},
	"Trainer3": {"pre": "MAP127_TRAINER_3", "defeat": "MAP127_TRAINER_3_DEFEAT", "portrait": "Graphics/Characters/trainer056.png"},
	"Trainer4": {"pre": "MAP127_TRAINER_4", "defeat": "MAP127_TRAINER_4_DEFEAT", "portrait": "Graphics/Characters/trainer090.png"},
	"Trainer5": {"pre": "MAP127_TRAINER_5", "defeat": "MAP127_TRAINER_5_DEFEAT", "portrait": "Graphics/Characters/trainer055.png"}
}

func _ready():
	Global.game.player.connect("trainer_battle", Callable(self, "trainer_battle"))
	for c in $NPC_Layer.get_children():
		if String(c.name).begins_with("Item") and Global.past_events.has("MAP127_ITEM_" + String(c.name).trim_prefix("Item") + "_TAKEN"):
			c.queue_free()
		elif String(c.name).begins_with("Trainer") and Global.past_events.has("MAP127_" + String(c.name).to_upper() + "_DEFEATED"):
			c.seeking = false
			c.defeated = true
...
func trainer_battle(npc_trainer):
	...
	if Global.game.battle.player_won:
		...
		Global.past_events.append("MAP127_" + String(npc_trainer.name).to_upper() + "_DEFEATED")
	Global.game.release_player()
