extends Node2D # gen_map.py Map078

var map_name = "Venesi City(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(112, 464):
		Global.game.play_dialogue("MAP078_NPC_1")
	if check_pos == Vector2(432, 272):
		Global.game.play_dialogue("MAP078_NPC_2")
	if check_pos == Vector2(336, 528):
		Global.game.play_dialogue("MAP078_NPC_3")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/VenesiCity/Venesi_City.tscn"
