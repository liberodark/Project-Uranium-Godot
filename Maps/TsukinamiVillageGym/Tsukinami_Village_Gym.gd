extends Node2D # gen_map.py Map175

var map_name = "Tsukinami Village(Gym)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(688, 2160):
		Global.game.play_dialogue("MAP175_SIGN_1")
	if check_pos == Vector2(880, 2160):
		Global.game.play_dialogue("MAP175_SIGN_2")
	if check_pos == Vector2(720, 2288):
		Global.game.play_dialogue("MAP175_NPC_1")
	return null

var _trainer_data = {
	"Trainer1": {"pre": "MAP175_TRAINER_1", "defeat": "MAP175_TRAINER_1_DEFEAT", "portrait": "Graphics/Characters/trainer115.png"},
	"Trainer2": {"pre": "MAP175_TRAINER_2", "defeat": "MAP175_TRAINER_2_DEFEAT", "portrait": "Graphics/Characters/trainer116.png"},
	"Trainer3": {"pre": "MAP175_TRAINER_3", "defeat": "MAP175_TRAINER_3_DEFEAT", "portrait": "Graphics/Characters/trainer113.png"},
	"Trainer4": {"pre": "MAP175_TRAINER_4", "defeat": "MAP175_TRAINER_4_DEFEAT", "portrait": "Graphics/Characters/trainer113.png"},
	"Trainer5": {"pre": "MAP175_TRAINER_5", "defeat": "MAP175_TRAINER_5_DEFEAT", "portrait": "Graphics/Characters/trainer114.png"},
	"Trainer6": {"pre": "MAP175_TRAINER_6", "defeat": "MAP175_TRAINER_6_DEFEAT", "portrait": "Graphics/Characters/trainer114.png"},
	"Trainer7": {"pre": "MAP175_TRAINER_7", "defeat": "MAP175_TRAINER_7_DEFEAT", "portrait": "Graphics/Characters/trainer114.png"},
	"Trainer8": {"pre": "MAP175_TRAINER_8", "defeat": "MAP175_TRAINER_8_DEFEAT", "portrait": "Graphics/Characters/trainer113.png"}
}

func _ready():
	Global.game.player.connect("trainer_battle", Callable(self, "trainer_battle"))
	for c in $NPC_Layer.get_children():
		if String(c.name).begins_with("Item") and Global.past_events.has("MAP175_ITEM_" + String(c.name).trim_prefix("Item") + "_TAKEN"):
			c.queue_free()
		elif String(c.name).begins_with("Trainer") and Global.past_events.has("MAP175_" + String(c.name).to_upper() + "_DEFEATED"):
			c.seeking = false
			c.defeated = true
...
func trainer_battle(npc_trainer):
	...
	if Global.game.battle.player_won:
		...
		Global.past_events.append("MAP175_" + String(npc_trainer.name).to_upper() + "_DEFEATED")
