extends Node2D # gen_map.py Map131

var map_name = "Championship Site (waiting)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(432, 784):
		Global.game.play_dialogue("MAP131_NPC_1")
	if check_pos == Vector2(368, 400):
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/ChampionshipSite/Championship_Site.tscn"
