extends Node2D # gen_map.py Map002

var map_name = "Burole Town (PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(336, 528):
		Global.game.play_dialogue("MAP002_NPC_1")
	if check_pos == Vector2(432, 240):
		Global.game.play_dialogue("MAP002_NPC_2")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/BuroleTown/Burole_Town.tscn"
