extends Node2D # gen_map.py Map026

var map_name = "Snowbank Town(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(112, 496):
		Global.game.play_dialogue("MAP026_NPC_1")
	if check_pos == Vector2(560, 368):
		Global.game.play_dialogue("MAP026_NPC_2")
	if check_pos == Vector2(336, 560):
		Global.game.play_dialogue("MAP026_NPC_3")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/SnowbankTown/Snowbank_Town.tscn"
