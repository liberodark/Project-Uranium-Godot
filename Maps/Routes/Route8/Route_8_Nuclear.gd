extends Node2D # gen_map.py Map187

var map_name = "Route 08 (Nuclear)"
...
func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(944, 2544):
		Global.game.play_dialogue("MAP187_SIGN_1")
	if check_pos == Vector2(2896, 2704):
		Global.game.play_dialogue("MAP187_NPC_1")
	if check_pos == Vector2(2864, 2704):
		Global.game.play_dialogue("MAP187_NPC_2")
	if check_pos == Vector2(2864, 2352):
		Global.game.play_dialogue("MAP187_NPC_3")
	if check_pos == Vector2(2480, 2000):
		Global.game.play_dialogue("MAP187_NPC_4")
	if check_pos == Vector2(2544, 2000):
		Global.game.play_dialogue("MAP187_NPC_5")
	if check_pos == Vector2(3248, 2448):
		_nurse_heal($NPC_Layer/Nurse1)
	if get_node_or_null("NPC_Layer/Item1") != null and check_pos == $NPC_Layer/Item1.position:
		Global.game.lock_player()
		Global.past_events.append("MAP187_ITEM_1_TAKEN")
...
var _trainer_data = {
	"Trainer1": {"pre": "MAP187_TRAINER_1", "defeat": "MAP187_TRAINER_1_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer10": {"pre": "MAP187_TRAINER_10", "defeat": "MAP187_TRAINER_10_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer11": {"pre": "MAP187_TRAINER_11", "defeat": "MAP187_TRAINER_11_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer12": {"pre": "MAP187_TRAINER_12", "defeat": "MAP187_TRAINER_12_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer13": {"pre": "MAP187_TRAINER_13", "defeat": "MAP187_TRAINER_13_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer14": {"pre": "MAP187_TRAINER_14", "defeat": "MAP187_TRAINER_14_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer2": {"pre": "MAP187_TRAINER_2", "defeat": "MAP187_TRAINER_2_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer3": {"pre": "MAP187_TRAINER_3", "defeat": "MAP187_TRAINER_3_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer4": {"pre": "MAP187_TRAINER_4", "defeat": "MAP187_TRAINER_4_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer5": {"pre": "MAP187_TRAINER_5", "defeat": "MAP187_TRAINER_5_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer6": {"pre": "MAP187_TRAINER_6", "defeat": "MAP187_TRAINER_6_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer7": {"pre": "MAP187_TRAINER_7", "defeat": "MAP187_TRAINER_7_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer8": {"pre": "MAP187_TRAINER_8", "defeat": "MAP187_TRAINER_8_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"},
	"Trainer9": {"pre": "MAP187_TRAINER_9", "defeat": "MAP187_TRAINER_9_DEFEAT", "portrait": "Graphics/Characters/trainer119.png"}
}

func _ready():
	Global.game.player.connect("trainer_battle", Callable(self, "trainer_battle"))
	for c in $NPC_Layer.get_children():
		if String(c.name).begins_with("Item") and Global.past_events.has("MAP187_ITEM_" + String(c.name).trim_prefix("Item") + "_TAKEN"):
			c.queue_free()
		elif String(c.name).begins_with("Trainer") and Global.past_events.has("MAP187_" + String(c.name).to_upper() + "_DEFEATED"):
			c.seeking = false
			c.defeated = true
...
func trainer_battle(npc_trainer):
	...
	if Global.game.battle.player_won:
		...
		Global.past_events.append("MAP187_" + String(npc_trainer.name).to_upper() + "_DEFEATED")
	Global.game.release_player()
