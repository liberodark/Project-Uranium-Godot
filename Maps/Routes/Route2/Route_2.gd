extends Node2D
var map_px_size = Vector2(1344, 1824)
var edge_connections = [["N", "res://Maps/NowtochCity/Nowtoch_City.tscn", 480, 2352, 2528], ["S", "res://Maps/KevlarTown/Kevlar_Town.tscn", 352, 16, 1600]]

var adjacent_scenes = [
	["res://Maps/KevlarTown/Kevlar_Town.tscn", Vector2(-352,1824)],
	["res://Maps/NowtochCity/Nowtoch_City.tscn", Vector2(-480, -2368)]
]

var background_music = "res://Audio/BGM/PU-Route_01.ogg"; # Same as route 1 apparently
...
func get_grass_cells():
	return get_node("Grass").get_used_cells(0)
