extends Node2D # gen_map.py Map100

var map_name = "Route 15(Rest Center)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(208, 240):
		Global.game.play_dialogue("MAP100_NPC_1")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/Routes/Route15/Route_15.tscn"
