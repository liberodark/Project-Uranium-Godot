extends Node2D # gen_map.py Map157

var map_name = "Vinoville Town(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(368, 560):
		Global.game.play_dialogue("MAP157_NPC_1")
	if check_pos == Vector2(528, 368):
		Global.game.play_dialogue("MAP157_NPC_2")
	if check_pos == Vector2(432, 272):
		Global.game.play_dialogue("MAP157_NPC_3")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/VinovilleTown/Vinoville_Town.tscn"
