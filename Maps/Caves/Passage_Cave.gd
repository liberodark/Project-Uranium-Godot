...
var background_music = "res://Audio/BGM/PU-Passage_Cave.ogg"; # Same as route 1 apparently
...
func trainer_battle(npc_trainer):
	...
	match npc_trainer:
		...
		trainer2:
			Global.game.get_node("Background_music").stream = load("res://Audio/ME/PU-PsychicAthlete_spotted.ogg")
