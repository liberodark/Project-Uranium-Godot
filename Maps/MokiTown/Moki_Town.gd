extends Node2D
var map_px_size = Vector2(2304, 2048)
var edge_connections = [["E", "res://Maps/Routes/Route3/Route_3.tscn", -832, 16, 2112]]

var adjacent_scenes = [
	["res://Maps/Routes/Route3/Route_3.tscn", Vector2(2304,832)]
]

var grassSprite = "res://Graphics/Autotiles/Tall_Grass.png"

var background_music = "res://Audio/BGM/PU-Moki_Town.ogg";
...
func event1(_body):
	...
	if !Global.past_events.has(event_name):
		...
		var sound = load("res://Audio/BGM/PU-Rival_Theme.ogg")
...
func event2():
	...
	Global.game.get_node("Background_music").stream = load("res://Audio/BGM/PU-Radio_Oak.ogg")
	...
	var time = Global.game.get_node("Background_music").get_playback_position()
	Global.game.get_node("Background_music").stop()
	sound = load("res://Audio/ME/Jinlge_-_KeyItem.ogg")
	sound.loop = false
	Global.game.get_node("Effect_music").stream = sound
	Global.game.get_node("Effect_music").play()
	...
	Global.inventory.add_item_by_name_multiple("Poké Ball", 5)

	time = Global.game.get_node("Background_music").get_playback_position()
	Global.game.get_node("Background_music").stop()
	sound = load("res://Audio/ME/Jingle_-_Regular_Item.ogg")
	sound.loop = false
	Global.game.get_node("Effect_music").stream = sound
	Global.game.get_node("Effect_music").play()
