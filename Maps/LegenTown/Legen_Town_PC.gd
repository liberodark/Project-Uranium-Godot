extends Node2D # gen_map.py Map165

var map_name = "Legen Town(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(144, 464):
		Global.game.play_dialogue("MAP165_NPC_1")
	if check_pos == Vector2(368, 560):
		Global.game.play_dialogue("MAP165_NPC_2")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/LegenTown/Legen_Town.tscn"
