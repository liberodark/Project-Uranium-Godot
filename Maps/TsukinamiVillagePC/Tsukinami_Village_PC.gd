extends Node2D # gen_map.py Map152

var map_name = "Tsukinami Village(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(144, 48):
		Global.game.play_dialogue("MAP152_SIGN_1")
	if check_pos == Vector2(304, 48):
		Global.game.play_dialogue("MAP152_SIGN_2")
	if check_pos == Vector2(528, 48):
		Global.game.play_dialogue("MAP152_SIGN_3")
	if check_pos == Vector2(112, 464):
		Global.game.play_dialogue("MAP152_NPC_1")
	if check_pos == Vector2(432, 272):
		Global.game.play_dialogue("MAP152_NPC_2")
	if check_pos == Vector2(336, 528):
		Global.game.play_dialogue("MAP152_NPC_3")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/TsukinamiVillage/Tsukinami_Village.tscn"
