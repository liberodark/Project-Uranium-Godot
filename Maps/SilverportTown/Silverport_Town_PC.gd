extends Node2D # gen_map.py Map024

var map_name = "Silverport Town(PC)"

func interaction(check_pos : Vector2, _direction):
	if check_pos == Vector2(112, 464):
		Global.game.play_dialogue("MAP024_NPC_1")
	if check_pos == Vector2(432, 560):
		Global.game.play_dialogue("MAP024_NPC_2")
	if check_pos == Vector2(400, 368):
		Global.game.play_dialogue("MAP024_NPC_3")
...
func _nurse_heal(npc):
	...
	if accepted:
		...
		await Global.game.event_dialogue_end
	Global.game.last_heal_point = "res://Maps/SilverportTown/Silverport_Town.tscn"
