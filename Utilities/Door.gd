...
@export_enum("Type 1 - Wood", "Type 2 - Glass", "Type 3 - Invisible", "Type 4 - Bi-Glass") var door_type: String # The texture of the exterior door
...
@onready var type4_texture = load("res://Graphics/Characters/door2_4.png")
	...
	if exterior:
		match door_type:
			"Type 1 - Wood", "Type 4 - Bi-Glass":
				sound = load("res://Audio/SE/Entering_Door.wav")
			"Type 2 - Glass":
				sound = load("res://Audio/SE/Entering_Door.wav") # Missing glass door sound?
		if sound != null:
		...
		sound = load("res://Audio/SE/Exit_Door.WAV")
		$AudioStreamPlayer.stream = sound
		$AudioStreamPlayer.play()
