extends Object
# TODO: Essentials function code 0x0A3 not fully implemented (plain move for now)

# The name of the move
var name = "Light Screen"

# The type of the move
var type = Type.PSYCHIC
...
var mechanic = {"kind": "screen", "stat": "spdef"}
