extends Object
# TODO: Essentials function code 0x0E0 not fully implemented (plain move for now)

# The name of the move
var name = "Fission Burst"

# The type of the move
var type = Type.NUCLEAR
...
var target_ability = MoveTarget.ALL
