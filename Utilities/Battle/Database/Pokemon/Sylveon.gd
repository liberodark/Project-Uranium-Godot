...
# Moveset by leveling
var moveset = [
	MoveSet.new(1, "Disarming Voice"),
	MoveSet.new(1, "Tail_Whip"),
	MoveSet.new(1, "Tackle"),
	MoveSet.new(1, "Helping Hand"),
	MoveSet.new(5, "Sand Attack"),
	MoveSet.new(9, "Fairy Wind"),
	MoveSet.new(13, "Quick Attack"),
	MoveSet.new(17, "Swift"),
	MoveSet.new(20, "Draining Kiss"),
	MoveSet.new(25, "Skill Swap"),
	MoveSet.new(25, "Misty Terrain"),
	MoveSet.new(33, "Light Screen"),
	MoveSet.new(37, "Moonblast"),
	MoveSet.new(41, "Last Resort"),
	MoveSet.new(45, "Psych Up")
]
