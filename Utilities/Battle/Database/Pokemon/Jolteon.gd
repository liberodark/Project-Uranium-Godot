...
var moveset = [
	...
	MoveSet.new(9, "Thunder_Shock"),
	MoveSet.new(13, "Quick Attack"),
	MoveSet.new(17, "Double Kick"),
	MoveSet.new(21, "Thunder Fang"),
	MoveSet.new(25, "Pin Missile"),
	MoveSet.new(29, "Agility"),
	MoveSet.new(33, "Thunder Wave"),
	MoveSet.new(37, "Discharge"),
	MoveSet.new(41, "Last Resort"),
	MoveSet.new(45, "Thunder")
]
